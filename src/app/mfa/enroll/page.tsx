...
export default function MfaEnrollPage() {
  ...
  if (backupCodes) {
    return (
      <AuthCard>
        <h1 className="text-2xl font-bold mb-2 text-center">Save your backup codes</h1>
        ...
        <button
          ...
          className="w-full bg-brand-blue text-white py-2 rounded-md hover:bg-brand-blue-hover"
        >
  ...
  return (
    <AuthCard>
      <h1 className="text-2xl font-bold mb-2 text-center">Set up multi-factor authentication</h1>
